...
/* pcscd filename */
#define PCSCD_BINARY "/data/evotor/pcscd/files/pcscd"

/* Enabled PC/SC lite features */
#define PCSCLITE_FEATURES " Linux i686-pc-linux-gnu serial usb usbdropdir=/data/evotor/pcscd/files/usb ipcdir=/data/evotor/pcscd/files/ipc configdir=/data/evotor/pcscd/files/etc"

/* directory containing USB drivers */
#define PCSCLITE_HP_DROPDIR "/data/evotor/pcscd/files/usb"
...
#define USE_IPCDIR "/data/evotor/pcscd/files/ipc"
